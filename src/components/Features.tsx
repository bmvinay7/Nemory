    ...
    <section className="py-12 sm:py-16 md:py-20 pb-0 relative bg-gray-50" id="features" ref={sectionRef}>
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 sm:w-6 sm:h-6"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"></path><polyline points="14 2 14 8 20 8"></polyline><path d="M10 10.5h4"></path><path d="M10 13h2"></path></svg>}
            title="Notion Integration"
            description="Seamlessly connects to your Notion workspace, analyzing all your notes, databases, and pages automatically."
            index={0}
          />
          <FeatureCard
            ...
            description="Advanced AI understands context, extracts key insights, and identifies actionable items from your notes."
            index={1}
          />
          <FeatureCard
